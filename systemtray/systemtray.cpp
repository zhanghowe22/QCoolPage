...
// 获取关于事件
QAction* SystemTray::getAboutSoftWare() const { return aboutSoftWare; }

// 关于软件
void SystemTray::aboutSlot() { QDesktopServices::openUrl(QUrl("https://github.com")); }

// 获取最小化事件
QAction* SystemTray::getMinWidget() const { return minWidget; }

// 获取显示事件
QAction* SystemTray::getShowWidget() const { return showWidget; }
